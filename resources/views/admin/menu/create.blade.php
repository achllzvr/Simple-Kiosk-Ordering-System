...
<div class="admin-page">
    <div class="row mb-4">
        <div class="col-md-12">
            <h1 class="page-title text-md-start">Create New Menu Item</h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <form action="{{ route('admin.menu.store') }}" method="POST" enctype="multipart/form-data" class="js-guard-submit">
                @csrf
